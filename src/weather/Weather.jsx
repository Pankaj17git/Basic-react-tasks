...
const Weather = () => {
  ...
  const getWeatherWarning = () => {
    ...
    if (temp >= 35) {
      return {
        message: "Excessive Heat Warning",
        color: "#d32f2f",
        bg: "#ffebee"
      };
    }
    ...
    if (
      ...
      return {
        message: "Severe Weather Advisory",
        color: "#6a1b9a",
        bg: "#f3e5f5"
      };
    }
                ...
                >
                  <CardContent>
                    <Grid container spacing={1} alignItems="center">
                      <Grid item xs>
                        <Typography variant="body1" sx={{ color: warning.color }}>
                          {warning.message}
                        </Typography>
                        <Typography variant="body2">
                          {weather.location.name} — Updated at {weather.current.last_updated}
                        </Typography>
                      </Grid>
                    </Grid>
                  </CardContent>
